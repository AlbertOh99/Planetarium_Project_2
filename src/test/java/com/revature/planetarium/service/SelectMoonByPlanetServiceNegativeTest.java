...
public class SelectMoonByPlanetServiceNegativeTest {
    ...
    @Test
    public void selectMoonByPlanetServiceNegativeTest() throws SQLException {
        Mockito.when(moonDao.readMoonsByPlanet(-1)).thenReturn(Collections.emptyList());
